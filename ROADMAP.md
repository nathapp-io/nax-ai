...
**Last updated:** 2026-09-01 · **Current milestone:** M4 — hardening (transport pass-through and thinking round-trip done; `CredentialStore` locking and the live canary open). M3 — recorded fixtures is done. M2 — real transport is done, publish pending. M1 merged to `main` in [#1](https://github.com/nathapp-io/nax-ai/pull/1) (`d3a3968`).
